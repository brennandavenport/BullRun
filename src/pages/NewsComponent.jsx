...
const NewsComponent = () => {
    ...
    const getNews = async () => {
        ...
        const url = 'https://api.marketaux.com/v1/news/all?symbols=TSLA,AAPL,SPY,BTC,NVDA&filter_entities=true&language=en&api_token=' + api + 'q'; //remove q later
    ...
    return (
        <div className="news-wrapper">
         <span class="news-asdfasdf">News Stentiment</span>
